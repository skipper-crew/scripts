...
require "/usr/home/mephius/irr.ru/config/rc.conf.php";

ini_set("memory_limit", "1024M");
ini_set('display_errors', true);

//define("IMG_PATH", __DIR__ . '/../../../../html/img/catalog');
define("IMG_PATH", '/usr/home/mephius/irr.ru/html/img/catalog');
...
//$file = fopen('/usr/home/script/img_clean/logs_i3/file0.txt', "r");
// /usr/home/script/img_clean/logs_i3/thread-1.txt
$file = fopen($opts['f'], "r");
